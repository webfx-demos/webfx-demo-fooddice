...
public class SpecialEffect{
	...
	public void makeEffect(){
		...
		switch (random.nextInt(6)){
			case 0: specialJump = true; break;
			case 1: slowFall = true; break;
			case 2: invulnerability = true; break;
			case 3: noCheckpoints = true; break;
			case 4: speedBoost = true; break;
			case 5: fog = true; break;
		}
	}
