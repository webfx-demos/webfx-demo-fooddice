...
public class Propeller extends GameObject implements Turnable{
	private static Image IMAGE = UiShared.loadImage("propeller.png");
	...
	public void render(GraphicsContext gc){
		...
		thisVertices[0] = UiShared.rotatePoint(new Point2D(this.x, this.y), this.angle, this.x+this.w/2, this.y+this.h/2);
		thisVertices[1] = UiShared.rotatePoint(new Point2D(this.x+this.w, this.y), this.angle, this.x+this.w/2, this.y+this.h/2);
		thisVertices[2] = UiShared.rotatePoint(new Point2D(this.x+this.w, this.y+this.h), this.angle, this.x+this.w/2, this.y+this.h/2);
		thisVertices[3] = UiShared.rotatePoint(new Point2D(this.x, this.y+this.h), this.angle, this.x+this.w/2, this.y+this.h/2);
