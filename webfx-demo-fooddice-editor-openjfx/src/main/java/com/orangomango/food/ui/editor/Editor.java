...
public class Editor{
	...
	private static class SelectedImage{
		...
		public void render(GraphicsContext gc, int sb){
			if (sb == 0 || sb == 16){
				this.w = PlatformType.SMALL.getWidth();
				this.h = PlatformType.SMALL.getHeight();
			} else if (sb == 1 || sb == 17){
				this.w = PlatformType.MEDIUM.getWidth();
				this.h = PlatformType.MEDIUM.getHeight();
			}
			if (this.image != null){
			...
			if (Integer.parseInt(this.id.split(";")[0]) == 7 || Integer.parseInt(this.id.split(";")[0]) == 24){
				...
				if (Integer.parseInt(this.id.split(";")[0]) == 21){
					...
					for (Point2D point : points){
						gc.drawImage(PlatformType.SMALL.getImage(), point.getX()- PlatformType.SMALL.getWidth()/2, point.getY()- PlatformType.SMALL.getHeight()/2, PlatformType.SMALL.getWidth(), PlatformType.SMALL.getHeight());
					}
					gc.restore();
					gc.drawImage(this.image, this.x, this.y, this.w, this.h);
	...
	private Image background = UiShared.loadImage("background.png");
	private int[][] angles;
	...
	public Node getLayout(){
		...
		layout.setPadding(new Insets(0, 5*UiShared.SCALE, 5*UiShared.SCALE, 5*UiShared.SCALE));
		layout.setHgap(5*UiShared.SCALE);
		layout.setVgap(5*UiShared.SCALE);
...
/*		if (getUserLevels().size() == 0){
			...
			if (e.getButton() == MouseButton.PRIMARY){
				if (this.selectedImage.getImage() == null){
					...
					if (this.selectedBlock == 0 || this.selectedBlock == 16){
						w = PlatformType.SMALL.getWidth();
						h = PlatformType.SMALL.getHeight();
					} else if (this.selectedBlock == 1 || this.selectedBlock == 17){
						w = PlatformType.MEDIUM.getWidth();
						h = PlatformType.MEDIUM.getHeight();
					}
		...
		accordion.setMinWidth(UiShared.WIDTH*0.3);
		accordion.setMinHeight(UiShared.HEIGHT*0.8);
		accordion.setMaxWidth(UiShared.WIDTH*0.3);
		accordion.setMaxHeight(UiShared.HEIGHT*0.8);
		
		// Blocks
		FlowPane blocksPane = new FlowPane();
		blocksPane.setHgap(10*UiShared.SCALE);
		blocksPane.setVgap(10*UiShared.SCALE);
		ToggleButton b1 = new ToggleButton();
		b1.setGraphic(new ImageView(UiShared.loadImage("platform_small.png")));
		b1.setOnAction(e -> {
			selectedBlock = 0;
			this.selectedImage.setImage(UiShared.loadImage("platform_small.png"));
		});
		ToggleButton b2 = new ToggleButton();
		b2.setGraphic(new ImageView(UiShared.loadImage("platform_medium.png")));
		b2.setOnAction(e -> {
			selectedBlock = 1;
			this.selectedImage.setImage(UiShared.loadImage("platform_medium.png"));
		});
		ToggleButton b3 = new ToggleButton();
		b3.setGraphic(new ImageView(UiShared.loadImage("ground.png")));
		b3.setOnAction(e -> {
			selectedBlock = 2;
			this.selectedImage.setImage(UiShared.loadImage("ground.png"));
		});
		ToggleButton b4 = new ToggleButton();
		b4.setGraphic(new ImageView(UiShared.loadImage("wood.png")));
		b4.setOnAction(e -> {
			selectedBlock = 3;
			this.selectedImage.setImage(UiShared.loadImage("wood.png"));
		});
		ToggleButton b17 = new ToggleButton();
		b17.setGraphic(new ImageView(UiShared.loadImage("platform_small_editor.png")));
		b17.setOnAction(e -> {
			selectedBlock = 16;
			this.selectedImage.setImage(UiShared.loadImage("platform_small_editor.png"));
		});
		ToggleButton b18 = new ToggleButton();
		b18.setGraphic(new ImageView(UiShared.loadImage("platform_medium_editor.png")));
		b18.setOnAction(e -> {
			selectedBlock = 17;
			this.selectedImage.setImage(UiShared.loadImage("platform_medium_editor.png"));
		});
		ToggleButton b22 = new ToggleButton();
		b22.setGraphic(new ImageView(UiShared.loadImage("rotatingPlatform.png")));
		b22.setOnAction(e -> {
			selectedBlock = 21;
			this.selectedImage.setImage(UiShared.loadImage("rotatingPlatform.png"));
		});
		ToggleButton b24 = new ToggleButton();
		b24.setGraphic(new ImageView(UiShared.loadImage("fallingBlock.png")));
		b24.setOnAction(e -> {
			selectedBlock = 23;
			this.selectedImage.setImage(UiShared.loadImage("fallingBlock.png"));
		});
		...
		damagePane.setHgap(10*UiShared.SCALE);
		damagePane.setVgap(10*UiShared.SCALE);
		ToggleButton b5 = new ToggleButton();
		b5.setGraphic(new ImageView(UiShared.loadImage("fire_0.png")));
		b5.setOnAction(e -> {
			selectedBlock = 4;
			this.selectedImage.setImage(UiShared.loadImage("fire_0.png"));
		});
		ToggleButton b6 = new ToggleButton();
		b6.setGraphic(new ImageView(UiShared.loadImage("cactus_0.png")));
		b6.setOnAction(e -> {
			selectedBlock = 5;
			this.selectedImage.setImage(UiShared.loadImage("cactus_0.png"));
		});
		ToggleButton b7 = new ToggleButton();
		b7.setGraphic(new ImageView(UiShared.loadImage("laser.png")));
		b7.setOnAction(e -> {
			selectedBlock = 6;
			this.selectedImage.setImage(UiShared.loadImage("laser.png"));
		});
		ToggleButton b8 = new ToggleButton();
		b8.setGraphic(new ImageView(UiShared.loadImage("shooter_0.png")));
		b8.setOnAction(e -> {
			selectedBlock = 7;
			this.selectedImage.setImage(UiShared.loadImage("shooter_0.png"));
		});
		ToggleButton b25 = new ToggleButton();
		b25.setGraphic(new ImageView(UiShared.loadImage("shooter2_0.png")));
		b25.setOnAction(e -> {
			selectedBlock = 24;
			this.selectedImage.setImage(UiShared.loadImage("shooter2_0.png"));
		});
		ToggleButton b20 = new ToggleButton();
		b20.setGraphic(new ImageView(UiShared.loadImage("propeller.png")));
		b20.setOnAction(e -> {
			selectedBlock = 19;
			this.selectedImage.setImage(UiShared.loadImage("propeller.png"));
		});
		ToggleButton b21 = new ToggleButton();
		b21.setGraphic(new ImageView(UiShared.loadImage("spike.png")));
		b21.setOnAction(e -> {
			selectedBlock = 20;
			this.selectedImage.setImage(UiShared.loadImage("spike.png"));
		});
		ToggleButton b23 = new ToggleButton();
		b23.setGraphic(new ImageView(UiShared.loadImage("lava.png")));
		b23.setOnAction(e -> {
			selectedBlock = 22;
			this.selectedImage.setImage(UiShared.loadImage("lava.png"));
		});
		...
		pushablePane.setHgap(10*UiShared.SCALE);
		pushablePane.setVgap(10*UiShared.SCALE);
		ToggleButton b9 = new ToggleButton();
		b9.setGraphic(new ImageView(UiShared.loadImage("box.png")));
		b9.setOnAction(e -> {
			selectedBlock = 8;
			this.selectedImage.setImage(UiShared.loadImage("box.png"));
		});
		ToggleButton b10 = new ToggleButton();
		b10.setGraphic(new ImageView(UiShared.loadImage("jumppad.png")));
		b10.setOnAction(e -> {
			selectedBlock = 9;
			this.selectedImage.setImage(UiShared.loadImage("jumppad.png"));
		});
		...
		activablePane.setHgap(10*UiShared.SCALE);
		activablePane.setVgap(10*UiShared.SCALE);
		ToggleButton b11 = new ToggleButton();
		b11.setGraphic(new ImageView(UiShared.loadImage("activatorpad_0.png")));
		b11.setOnAction(e -> {
			selectedBlock = 10;
			this.selectedImage.setImage(UiShared.loadImage("activatorpad_0.png"));
		});
		ToggleButton b12 = new ToggleButton();
		b12.setGraphic(new ImageView(UiShared.loadImage("door_0.png")));
		b12.setOnAction(e -> {
			selectedBlock = 11;
			this.selectedImage.setImage(UiShared.loadImage("door_0.png"));
		});
		ToggleButton b19 = new ToggleButton();
		b19.setGraphic(new ImageView(UiShared.loadImage("portal.png")));
		b19.setOnAction(e -> {
			selectedBlock = 18;
			this.selectedImage.setImage(UiShared.loadImage("portal.png"));
		});
		...
		collectablePane.setHgap(10*UiShared.SCALE);
		collectablePane.setVgap(10*UiShared.SCALE);
		ToggleButton b13 = new ToggleButton();
		b13.setGraphic(new ImageView(UiShared.loadImage("coin.png")));
		b13.setOnAction(e -> {
			selectedBlock = 12;
			this.selectedImage.setImage(UiShared.loadImage("coin.png"));
		});
		...
		specialPane.setHgap(10*UiShared.SCALE);
		specialPane.setVgap(10*UiShared.SCALE);
		ToggleButton b14 = new ToggleButton();
		b14.setGraphic(new ImageView(UiShared.loadImage("checkpoint_off.png")));
		b14.setOnAction(e -> {
			selectedBlock = 13;
			this.selectedImage.setImage(UiShared.loadImage("checkpoint_off.png"));
		});
		b14.setToggleGroup(tg);
		ToggleButton b15 = new ToggleButton();
		b15.setGraphic(new ImageView(UiShared.loadImage("player_3.png")));
		b15.setOnAction(e -> {
			selectedBlock = 14;
			this.selectedImage.setImage(UiShared.loadImage("player_3.png"));
		});
		b15.setToggleGroup(tg);
		ToggleButton b16 = new ToggleButton();
		b16.setGraphic(new ImageView(UiShared.loadImage("exit.png")));
		b16.setOnAction(e -> {
			selectedBlock = 15;
			this.selectedImage.setImage(UiShared.loadImage("exit.png"));
		});
		...
		canvasPane.setMinWidth(UiShared.WIDTH*0.65);
		canvasPane.setMinHeight(UiShared.HEIGHT*0.8);
		canvasPane.setMaxWidth(UiShared.WIDTH*0.65);
		canvasPane.setMaxHeight(UiShared.HEIGHT*0.8);
		...
		this.props.setPadding(new Insets(5*UiShared.SCALE, 5*UiShared.SCALE, 5*UiShared.SCALE, 5*UiShared.SCALE));
		this.props.setHgap(5*UiShared.SCALE);
		this.props.setVgap(5*UiShared.SCALE);
		updatePropsLayout();
		...
		run.setOnAction(e -> {
			if (containsItem(14) && containsItem(15)){
				this.loop.stop();
				this.saveFile();
				UiShared.goToGameScreen(-1, this.save());
			} else {
	...
	private void updatePropsLayout(){
		...
		if (this.clickSelected == null){
			...
			view.setFitWidth(200*UiShared.SCALE);
		...
		try {
			...
			do {
				...
				if (c == 0){
					...
					Image image = UiShared.loadImage(imageNames[type]);
